...
hold on; grid on;
errorbar(nc_nr, pnas_r_err, pnas_r_sd, '-', 'LineWidth',2);
plot(nc_nr,pnas_d_err, '-d', 'LineWidth',2);
...
hold on; grid on;
errorbar(nc_nr, pnas_r_t, pnas_r_t_sd, '-', 'LineWidth',2);
semilogy(nc_nr,pnas_d_t, '-d', 'LineWidth',2);
